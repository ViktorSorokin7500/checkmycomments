...
import { MotionDiv, MotionH1, MotionH2, MotionSection } from "../shared";
...
export function HeroSection({ dictionary, lang }: HeroSectionProps) {
  ...
  return (
    <MotionSection
      ...
      initial="hidden"
      animate="visible"
      className="relative mx-auto flex flex-col z-0 items-center justify-center py-6 sm:py-12 lg:pb-16 transition-all animate-in px-4 lg:px-12 max-w-7xl"
    >
      <MotionDiv
        variants={itemVariants}
        className="relative p-[1px] overflow-hidden rounded-full bg-linear-to-r from-green-200 via-green-500 to-green-800 animate-gradient-x cursor-default group"
      >
        <Badge
          variant={"secondary"}
